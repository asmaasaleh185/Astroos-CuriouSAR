...
const teamMembers = {
  "ahmed-elghrabawy": {
    name: "AHMED ELGHRABAWY",
    role: "Team Leader - Web Developer",
    email: "ahmedelghrabawy28@gmail.com",
  },
  "asmaa-saleh": {
    name: "ASMAA SALEH",
    role: "Web Developer",
  ...
  "ahmed-azab": {
    name: "AHMED AZAB",
    role: "GIS Researcher",
    email: "ahmed.aazab.dev@gmail.com",
  },
  "al-hussien-raed": {
    name: "AL-HUSSIEN RAED",
    role: "Video Editor",
    email: "kacc2431@gmail.com",
  },
  "mahmoud-wadea": {
    name: "MAHMOUD WADEA",
    role: "Storyteller",
    email: "mahmoudwadea54@gmail.com",
  },
};
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Open popup when team member is clicked
  teamCards.forEach((card) => {
    card.addEventListener("click", function () {
      ...
      if (member) {
        document.getElementById("popupImg").src = this.querySelector("img").src;
        document.getElementById("popupName").textContent = member.name;
        document.getElementById("popupRole").textContent = member.role;
...
function initScrollAnimations() {
  const panels = document.querySelectorAll(
    '.story-panel[data-scroll="fade-in"]'
  );
